...
var DBase_1 = require("../dbase/DBase");
var DateStr_1 = require("../dbase/DateStr");
var users_table_1 = require("./sql/users_table");
var tasks_table_1 = require("./sql/tasks_table");
var status_table_1 = require("./sql/status_table");
var priority_table_1 = require("./sql/priority_table");
function run() {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4, db.query(users_table_1.users_table.sql)];
                case 2:
                    _a.sent();
                    return [4, db.query(tasks_table_1.tasks_table.sql)];
                case 3:
                    _a.sent();
                    return [4, db.query(status_table_1.status_table.sql)];
                case 4:
                    _a.sent();
                    return [4, db.query(priority_table_1.priority_table.sql)];
                case 5:
                    _a.sent();
                    console.log("TABLE ADD");
                    return [4, db.query("INSERT INTO status(namestatus) VALUES ('Задача назначена');" +
                ...
                case 6:
                    _a.sent();
                    return [4, db.query("INSERT INTO priority(namepriority) VALUES ('Низкий');" +
